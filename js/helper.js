...
var HTMLskillsStart = '<h3 id="skillsH3">Skills Map:</h3><ul id="skills" class="flex-box"></ul>';
var HTMLskills = '<li class="flex-item"><span class="white-text">%data%</span></li>';
var HTMLskillsTree = '<h3 id="skillsH3">Complete Skills Tree:</h3>';

var HTMLworkStart = '<div class="work-entry"></div>';
var HTMLworkEmployer = '<h3 class=work-employer-title>%data%';
...
var HTMLprojectTitle = '<h3 class=project-title>%data%</ah3';
var HTMLprojectDates = '<div class="date-text">%data%</div>';
var HTMLprojectDescription = '<p><br>%data%</p>';
var HTMLprojectImage = '<img src="%data%">';

var HTMLschoolStart = '<div class="education-entry"></div>';
var HTMLschoolName = '<h3 class="school-name">%data%</h3>';
...
var HTMLcertificationSchoolName = '<h3 class="school-name">%data%</h3>';
var HTMLcertificationType = ' -- %data%';
...
var HTMLonlineSchoolName = '<h3 class="online-name">%data%</h3>';
var HTMLonlineTitleType = ' -- %data%';
...
function initializeMap() {
    ...
    */
    function createMapMarker(placeData) {
        ...
        var saying;
        var infoImage;
        if (name.match(/alpharetta/gi)) {
            saying = "Rise Up!";
            infoImage = '<img class="infoWindowPic" alt="Picture of City" src="images/ATL.jpg">';
        } else if (name.match(/seattle|redmond|bothell?/gi)) {
            saying = "Go Hawks!";
            infoImage = '<img class="infoWindowPic" alt="Picture of City" src="images/needle.jpg">';
        } else if (name.match(/moorhead/gi)) {
            saying = "Yeah, you betcha!";
            infoImage = '<img class="infoWindowPic" alt="Picture of City" src="images/moorhead.jpg">';
        }
        ...
        // about a location.
        var contentString = '<div id="infoContent" class="infoWindowContent">' +
            '<div id="heading" class="infoWindowCity">' +
